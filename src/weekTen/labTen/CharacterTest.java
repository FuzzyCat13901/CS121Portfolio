...
// Tests setting and getting health values
        ...
        System.out.println("\nWarrior: "+warrior.getName() + " Health: " +
                warrior.getHealth()); // Expected: 90
        mage.setHealth(85);
        System.out.println("\nMage: "+mage.getName() + " Health: " +
                mage.getHealth()); // Expected: 85
        archer.setHealth(-10); // Invalid health value
        System.out.println("\nArcher: "+archer.getName() + " Health: " +
                archer.getHealth()); // Expected: 0 (no negative health)
    }
}
